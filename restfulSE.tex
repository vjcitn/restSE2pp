...
satisfies the API of the Bioconductor \Biocpackage{DelayedArray} package \citep{Pages2018}.  
...
In conjunction with the \Biocpackage{rhdf5client} and \CRANpackage{bigrquery} packages,
...
obtained from the \Biocpackage{curatedTCGAData} system \citep{Ramos2017}.
Code at the top of Figure \ref{pancanPanel} employs
functions in the \Biocpackage{BiocOncoTK} package that build on
...
is demonstrated in the \Biocpackage{BiocOncoTK} vignette.
...
\textit{Reliability:} 
The \Biocpackage{restfulSE}, \Biocpackage{rhdf5client},
and \Biocpackage{BiocOncoTK} packages are accompanied by detailed unit
...
and cost.  We rely on the \CRANpackage{bigrquery} and \CRANpackage{dbplyr} packages for
...
The vignette for package \Biocpackage{BiocOncoTK} includes all
