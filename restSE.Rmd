...
```{r seSchema, out.width='60%', fig.cap = 'Schematic of SummarizedExperiment class structure.  The `sizeFactors` component is specific to a subclass for single cell data.',echo=FALSE}
